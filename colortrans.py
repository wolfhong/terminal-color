#! /usr/bin/env python
###############################
# forked from https://gist.github.com/MicahElliott/719710
###############################
...
def print_all():
    ...
    for short, rgb in CLUT:
        sys.stdout.write('\033[48;5;%sm%s:%s' % (short, short, rgb))  # background color
        sys.stdout.write("\033[0m  ")
        sys.stdout.write('\033[38;5;%sm%s:%s' % (short, short, rgb))  # foreground color
        sys.stdout.write("\033[0m\n")
